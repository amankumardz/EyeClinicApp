        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CartItems_Glasses_GlassId",
                        column: x => x.GlassId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItems_Glasses_GlassId",
                        column: x => x.GlassId,
                        principalTable: "Glasses",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItems_GlassId",
                table: "CartItems",
                column: "GlassId");

            migrationBuilder.CreateIndex(
                name: "IX_CartItems_UserId_GlassId",
                table: "CartItems",
                columns: new[] { "UserId", "GlassId" },
                unique: true,
                filter: "[UserId] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_GlassId",
                table: "OrderItems",
                column: "GlassId");
