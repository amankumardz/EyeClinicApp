...
namespace EyeClinicApp.Migrations
{
    ...
    [Migration("20260404200922_AddGlassCategory")]
    partial class AddGlassCategory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EyeClinicApp.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("EyeClinicApp.Models.Glass", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EyeClinicApp.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EyeClinicApp.Models.PersonProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EyeClinicApp.Models.CartItem", b =>
                {
                    b.HasOne("EyeClinicApp.Models.Glass", "Glass")
                        .WithMany()
            ...
            modelBuilder.Entity("EyeClinicApp.Models.OrderItem", b =>
                {
                    ...
                    b.HasOne("EyeClinicApp.Models.Order", "Order")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("EyeClinicApp.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
